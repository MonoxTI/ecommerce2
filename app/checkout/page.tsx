...
export default function CheckoutPage() {
  ...
  async function handlePay() {
    ...
    // 3. Redirect to Paystack hosted payment page
          ...
          <div className="lg:col-span-1">
            <div className="bg-[#111111] border border-white/[0.06] p-6 sticky top-24">
              ...
              <div className="mt-4 pt-4 border-t border-white/[0.06]">
                <p className="text-[#6B6B6B] text-[0.65rem] leading-relaxed">
                  By placing your order you agree to our{" "}
                  <a href="/terms" className="text-[#C9A84C] hover:underline" target="_blank">Terms of Service</a>,{" "}
                  <a href="/privacy" className="text-[#C9A84C] hover:underline" target="_blank">Privacy Policy</a> and{" "}
                  <a href="/returns" className="text-[#C9A84C] hover:underline" target="_blank">Returns Policy</a>.
                </p>
              </div>
            </div>
          </div>
